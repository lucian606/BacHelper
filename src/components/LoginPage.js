...
export default function LoginPage() {
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center">
        ...
        <div className="max-w-sm md:max-w-md xl:max-w-xl 2xl:max-w-2xl w-full mx-auto mt-4 bg-gray-200 p-8 border border-gray-300">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    <button className="w-full text-sm xl:text-xl 2xl:text-2xl p-2 mt-4 text-center text-white bg-blue-500 rounded hover:bg-blue-700">Sign In</button>
                </div>
                <div class="flex justify-center items-center">
                    <button className="w-full text-sm xl:text-xl 2xl:text-2xl p-2 outline outline-1 bg-white rounded hover:bg-gray-200 flex items-center justify-center">
                ...
                <div class="flex justify-center items-center">
                    <button className="w-full text-sm xl:text-xl 2xl:text-2xl p-2 text-white bg-red-700 rounded hover:bg-red-800 flex items-center justify-center">
                        <svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                            <g transform="matrix(1, 0, 0, 1, 27.009001, -39.238998)">
